            ...
            <div class="col-12 my-5">
                <form action="{{ route('admin.projects.store')}}" method="POST" class="border p-3 w-100">
                    ...
                    <div class="form-group my-4">
                        ...
                        <textarea name="description" id="description" placeholder="Inserisci la Descrizione del Progetto" class="form-control" value="{{ old('description') }}" cols="30" rows="10" required></textarea>
                    </div>
                    <div class="form-group my-4">
                    ...
                    <div class="col-12 d-flex justify-content-center align-items-center my-5">
                        <button class="btn btn-success px-5" type="submit">CREA</button>
                    </div>
                </form>
            </div>
        </div>
